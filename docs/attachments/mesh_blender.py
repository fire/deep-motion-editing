...
class ArmatureMenu(bpy.types.Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator(
            "wm.mesh_from_armature", text="Pyramid"
        ).mesh_type = "Pyramid"  # from here
        layout.operator(
            "wm.mesh_from_armature", text="Tapered"
        ).mesh_type = "Tapered"  # from here
        layout.operator(
            "wm.mesh_from_armature", text="Box"
        ).mesh_type = "Box"  # from here

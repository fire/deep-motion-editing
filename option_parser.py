...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default="cuda:0",
        help="cuda device number, eg:[cuda:0]",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="linear",
        help="'stride2' or 'nearest', 'linear'",
    )
    parser.add_argument(
        "--downsampling", type=str, default="stride2", help="stride2 or max_pooling"
    )
    parser.add_argument(
        "--batch_normalization", type=int, default=0, help="batch_norm: 1 or 0"
    )
    parser.add_argument(
        "--activation",
        type=str,
    ...
    parser.add_argument("--epoch_num", type=int, default=201, help="epoch_num")
    parser.add_argument(
...
def get_std_bvh(args=None, dataset=None):
    ...
    std_bvh = "./datasets/Motions/std_bvhs/{}.bvh".format(dataset)
    return std_bvh
